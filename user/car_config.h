...
/*--------------------------------------------------
 * IMU 陀螺仪型号选择 (二选一)
 *   1 = IMU660RA (逐飞, 芯片BMI270, ChipID=0x24)
 *   2 = LSM6DSR  (ST,   芯片LSM6DSRTR, ChipID=0x6B)
 *
 * 【修改方法】把下面的数字改成 1 或 2
 *--------------------------------------------------*/
#define IMU_SELECT              2               // ← 改这里! 1=IMU660RA  2=LSM6DSR
...
#define BUZZER_ACTIVE_HIGH      0               // 0=低电平响 [修正: 您的蜂鸣器是低电平有效]
